...
public class UpdateAnuncioRequest {
    ...
    @Schema(description = "CEP do imóvel", example = "31270901")
    @NotBlank(message = "{not_blank}")
    private String cep;
    ...
    @Schema(description = "Estado (sigla com 2 letras)", example = "MG")
    @NotNull(message = "{not_null}")
    @ValueOfEnum(enumClass = Estado.class)
    private String estado;

    @Schema(description = "Logradouro (Rua, Avenida)", example = "Av. Antônio Carlos")
    @NotBlank(message = "{not_blank}")
    private String logradouro;

    @Schema(description = "Número do endereço", example = "6627")
    @NotBlank(message = "{not_blank}")
    private String numero;

    @Schema(description = "Bairro", example = "Pampulha")
    @NotBlank(message = "{not_blank}")
